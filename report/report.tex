...
\title{Relational Deep Differential Reinforcement Learning in Large Action Spaces}
...
\pagestyle{fancy}
\fancyhf{}
\lhead{Presented as project for RL (B 659 Spring 2022)}
\rfoot{Page \thepage}
\begin{document}
\maketitle
...
\begin{abstract}
    In this project I introduce a novel way to build relational reasoning between states where scene is perceived by the agent as the
\end{abstract}
...
\section{INTRODUCTION}
	...
	Relational Inductive Biases have been explored in many approaches in past. But for a very long time most of these works explored structured approaches (, most of which were required explicitly hand designed formulations of these relations between entities currently in action.   of which most notable and famous are ~\cite{DBLP:journals/corr/abs-1806-01261} and ~\cite{zambaldi2018deep}. Both of these works were the first to establish importance of learning relations between different entities in a reinforcement learning setting.
...
Dr. Doe is member of the SOBRAEP, SBA and IEEE. Between 1998 and 2000, he was editor of the Brazilian Power Electronics Journal.
