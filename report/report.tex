...
%% (1) a description of what you set out to do, (2) what you actually did (please include
% details for anything which is not straight from the textbook/lectures/paper), (3) the results and
% conclusions from your investigation, (4) a discussion of any insights or difficulties you found in
% this project, and (5) how you might continue the work or redo the work if you were to start from
% scratch.
\end{document}
